        ...
        if (Array.isArray(data)) {
            data.forEach((row, index) => {
                ...
                tr.innerHTML = `
                    ...
                    <td style="text-align:center"><span style="padding:4px 8px; border-radius:8px; background:${colorClass}; color:white; font-weight:bold">${p.toFixed(1)}%</span></td>
            ...
            tbody.innerHTML = '<tr><td colspan="25" style="text-align:center; padding: 20px;">Ma\'lumot topilmadi</td></tr>';
        }
    } catch (e) {
        console.error("Tuman Data Error:", e);
        const tbody = document.querySelector('#tumanTable tbody');
        if (tbody) tbody.innerHTML = `<tr><td colspan="25" style="text-align:center; color:red; padding: 20px;">Xatolik: ${e.message}</td></tr>`;
    }
}
