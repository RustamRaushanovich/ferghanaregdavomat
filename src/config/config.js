...
module.exports = {
    ...
    ADMIN_RECIPIENTS: [
        65002404,    // User
        291508733,   // Sherzod Dolimov
        121730039,   // Dilafruz Kasimova
        5310405293,  // Abrorjon Azimov
        6067526465   // Aktam aka
    ],
    SPECIALIST_IDS: [5310405293, 291508733],
    RESTRICTED_IDS: [
    ...
    DISTRICT_ADMINS: {
        ...
        341362677: "O'zbekiston tumani", // Fixed duplicate ID or check if correct
